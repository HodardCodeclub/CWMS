...
<a href="branches.php" class="btn btn-success">See all branches</a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <input class="form-control" type="text" name="user_name" placeholder="Enter Branch name" />
                    <label class="control-label">Branch code.</label></td>
													<input class="form-control" type="text" name="user_name" placeholder="Enter Branch code" />
													...
													<div class="row">
														...
														<div class="col-md-2">
															<input class="form-control"  type="text" name="user_job" value="+250" readonly />
																	...
																	<div class="col-md-10">
																<input class="form-control" type="text" name="user_job" placeholder=" Enter Mobile number"  />
																	</div>
