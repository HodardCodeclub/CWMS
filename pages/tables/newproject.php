...
<a href="branches.php" class="btn btn-success">See all projects</a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<select class="form-control" id="sel1" name="level">
										...
										<label class="control-label">Project name.</label></td>
													<input class="form-control" type="text" name="user_name" placeholder="Enter Project name" />
										<label class="control-label">Site address.</label>
													<input class="form-control" type="text" name="user_name" placeholder="Enter Site address" />
										...
										<label class="control-label">Contact person.</label>
				                          ...
				                          <input class="form-control" type="text" name="user_name" placeholder="Enter Person email" />
														...
														<label class="control-label">Start date.</label></td>
																	<input class="form-control" type="date" name="user_name" placeholder="Enter Branch emai" />
																	...
																	<label class="control-label">End date.</label></td>
																						...
																						<label class="control-label">Project amount.</label>
																									<input class="form-control" type="text" name="user_name" placeholder="Enter Project amount" />
<br/>
