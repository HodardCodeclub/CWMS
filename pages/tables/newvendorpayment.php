...
<a href="branches.php" class="btn btn-success">See all vendor payment request</a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<select class="form-control" id="sel1" name="level">
										...
										<label class="control-label">Invoice date.</label></td>
													<input class="form-control" type="date" name="user_name" />
										<label class="control-label"> Vendor invoice number.</label>
													<input class="form-control" type="text" name="user_name" placeholder="Enter Vendor invoice number" />
										...
										<label class="control-label">Order date.</label>
													...
													<label class="control-label">Original amount.</label>
																	<input class="form-control" type="text" name="user_name" placeholder="Enter Original amount" />
														<label class="control-label">Due amount.</label></td>
																	<input class="form-control" type="text" name="user_name" placeholder="Enter Due amount" />
														<label class="control-label">Vendor payment request date</label>
																	...
																	<label class="control-label">Due date of payment.</label>
																					...
																					<select class="form-control" id="sel1" name="level">
																						<option value="1">Select Requested by.</option>
																						<option value="2">intermediate</option>
																						<option value="3">advanced</option>

																						</select>
														<label class="control-label">Reason for payment.</label></td>
																	<input class="form-control" type="text" name="user_name" placeholder="Enter Reason for payment." />
